"use strict";var puppeteer;module.watch(require('puppeteer'),{default(v){puppeteer=v}},0);var assert;module.watch(require('assert'),{default(v){assert=v}},1);var svgdom;module.watch(require('../dom'),{default(v){svgdom=v}},2);/* global describe, it, before, after, beforeEach */
